...
@Scope("session")
@Controller("propietarioPorDistritoReport")
public class PropietarioPorDistritoReport extends AbstractReportBean{

	private final String COMPILE_FILE_NAME = "PropietarioPorDistrito";
