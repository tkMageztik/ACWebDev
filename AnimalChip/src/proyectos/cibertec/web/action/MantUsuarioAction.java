...
@Scope("session")
@Controller("mantUsuarioAction")
public class MantUsuarioAction {
	@Autowired
	...
	/**
	 * Retorna el usuario logeado en el sistema.
	 * @return Objeto Usuario con los datos del usuario autenticado.
	 */
	 ...
	 * Los usuarios obtenidos serán los pertenecientes a la empresa buscada
	 * con el método buscarEmpresa.
	 */
	private void cargarListaUsuarios(){
		System.out.println("Cargando!! " + empresaSeleccionada==null );
	...
	public void buscarEmpresa(){
		System.out.println("Tratando de Cargar lista");
		try{			
			if(rucEmpresa==null || rucEmpresa.length()<=0){
				System.out.println("Error, primer if entro");
				...
				if(resultList.size()>0){
					System.out.println("Vamos a buscar y cargar");
	...
	public void insertarUsuario(){		
		...
		if(empresaSeleccionada.getMaximoUsuarios()<= listaUsuariosEmpresa.size()){
